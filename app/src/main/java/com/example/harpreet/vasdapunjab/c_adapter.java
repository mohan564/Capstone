...
private HashMap<String,List<String>>hashMap;
    ...
    public c_adapter(Context context, List<String> list, HashMap<String, List<String>> hashMap)
    {
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        ...
        if(view==null)
        {
            ...
            view=layoutInflater.inflate(R.layout.c_parent,null);
        }
        TextView my_text_parent=view.findViewById(R.id.c_text_parent);
    ...
    public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        {
            LayoutInflater layoutInflater= (LayoutInflater) this.context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            view=layoutInflater.inflate(R.layout.c_child,null);
        }
        TextView my_text_child=view.findViewById(R.id.c_text_child);
